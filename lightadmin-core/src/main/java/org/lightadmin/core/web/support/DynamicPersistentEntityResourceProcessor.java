...
public class DynamicPersistentEntityResourceProcessor implements ResourceProcessor<PersistentEntityResource> {
    ...
    public DynamicPersistentEntityResourceProcessor(GlobalAdministrationConfiguration adminConfiguration,
    		...
    		DomainEntityLinks domainEntityLinks, ResourceMappings resourceMappings, Associations associations) {
    ...
    public PersistentEntityResource process(PersistentEntityResource persistentEntityResource) {
        ...
        PersistentEntityWrapper persistentEntityWrapper = PersistentEntityWrapper.persistentEntity(value, dynamicProperties, stringRepresentation, domainLink, managedDomainType, primaryKey);
